...
cd /home/ubuntu/coin-collecting-app/ && git pull origin master && /home/ubuntu/.nvm/versions/node/v8.2.1/bin/npm i && /home/ubuntu/.nvm/versions/node/v8.2.1/bin/npm run build && rm -rf /var/www/html/* && cp -a /home/ubuntu/coin-collecting-app/public/. /var/www/html/
